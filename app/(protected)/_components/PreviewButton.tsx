...
export default function PreviewButton({title}: Props) {
  return (
    <Dialog>
    ...
    <DialogContent className="min-w-[90vw] max-w-[90vw]">
      <DialogHeader>
        ...
        <DialogDescription>
          You get to see a preview of the {title} when sent via mail and the pdf version.
        </DialogDescription>
      </DialogHeader>
        ...
        <div className="flex  flex-col w-full ">
            ...
            <div className="rounded-md flex w-full bg-slate-200 p-6">
                ...
                <span>
                    ...
                    Your {title} from [Your Company Name] is 
                    ready for payment. Please review the attached {title} 
                    and make the payment at your earliest convenience.
                </span>
                <span>
                    {title} Number: [{title} Number] <br />
                    {title} Issue Date: [Invoice Date] <br />
